...
export default function DropDown2({ content }) {
  ...
  return (
    <div ref={dropdownRef2} onClick={() => setOpen(true)} className="">
      <Menu as="div" className="relative inline-block text-left">
        ...
        >
          <Menu.Items
            className={`absolute right-0 mt-2 w-fit origin-top-right divide-y  rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-none`}
          >
