...
def downgrade() -> None:
    ...
    sa.Column('proj_risk_id', sa.BIGINT(), autoincrement=False, nullable=True),
    sa.Column('prog_risk_id', sa.BIGINT(), autoincrement=False, nullable=True),
    sa.Column('port_risk_id', sa.BIGINT(), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['port_risk_id'], ['portfolios.id'], name='risks_port_risk_id_fkey'),
    sa.ForeignKeyConstraint(['prog_risk_id'], ['programs.id'], name='risks_prog_risk_id_fkey'),
    sa.ForeignKeyConstraint(['proj_risk_id'], ['projects.id'], name='risks_proj_risk_id_fkey'),
